module mpi_setup
  ...
  ! For MPI-IO
  integer, public, parameter :: minfonull = MPI_INFO_NULL
  integer, public, parameter :: amode = mpi_mode_wronly+mpi_mode_create
  integer, public, parameter :: amoder = mpi_mode_rdonly
  integer, public, parameter :: order = mpi_order_fortran
  integer, public, parameter :: mkind = mpi_offset_kind
