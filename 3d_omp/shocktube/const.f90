...
! time control parameters
  logical,parameter :: restart = .true. ! if .true. then start from restart data
  integer,parameter :: nstop = 100000000
  real(8),parameter :: safety = 0.1d0 ! CFL number
  real(8),parameter :: tend = 0.4d0, dtout = 0.1d0
...
! grid & MPI
  ...
  integer,parameter :: ix = 1600+2*margin,jx=1+2*margin,kx=1+2*margin
  ...
  real(8),parameter :: xmax =  1d0, ymax = +1.d0, zmax = 1.D0
