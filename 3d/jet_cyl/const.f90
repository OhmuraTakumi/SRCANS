...
! time control parameters
  ...
  real(8),parameter :: tend = 3d0, dtout = 0.1d0
...
! grid & MPI
  ...
  integer,parameter :: ix = 50+2*margin,jx=1+2*margin,kx=100+2*margin
  ...
  real(8),parameter :: xmin =  0.d0, ymin = 0.0d0, zmin =0.d0
  real(8),parameter :: xmax =  0.5d0, ymax = 1.0d0, zmax = 1D0
  ...
  real(8),parameter :: r_jet = 0.1d0
  integer,parameter :: zin = 12
end module const
